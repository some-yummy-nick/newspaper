...
import config from '../config.js' // конфигурационный файл
...
export const stylesBuild = () => {
    ...
    return src(`${config.src.scss}/main.scss`, { sourcemaps: config.isDev }) // входящие файлы
        .pipe(
...
export const stylesWatch = () => {
    watch(`${config.src.scss}/**/*.scss`, stylesBuild)
}